        ...
        <div class="row">
            <div class="col-md-12">
                <div class="heading-section justify-content-center">
                    <h2 class="tf-title pb-30">Sell or Buy a Plate in Just a Few Steps</h2>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="tf-box-icon relative text-center">
                    <div class="image">
                        <img src="./assets/plates/plates/1.png" alt="">
                        <p>Step 1</p>
                    </div>
                    <h4 class="heading"><a href="#!">Create Your Account</a></h4>
                    <p class="content">Sign up in minutes and join our growing community of plate enthusiasts.</p>
                    <div class="arrow">
                        <svg width="114" height="114" viewBox="0 0 114 114" fill="none"
                            ...
                            <g clip-path="url(#clip0_625_20131)">
                                ...
                                <path
                                    ...
                                    fill="#919191" />
                                <circle cx="8.69433" cy="59.7296" r="3.91825"
                                    transform="rotate(-135 8.69433 59.7296)" stroke="#919191" stroke-width="2" />
                            </g>
                            <defs>
                                <clipPath id="clip0_625_20131">
                                    <rect width="76.2328" height="83.6102" fill="white"
            ...
            <div class="col-lg-4 col-md-6">
                <div class="tf-box-icon relative text-center type-1">
                    <div class="image">
                        <img src="./assets/plates/plates/2.png" alt="">
                        <p>Step 2</p>
                    </div>
                    <h4 class="heading"><a href="#!">List Your Number Plate</a></h4>
                    <p class="content">Upload your plate details and set your price. Showcase your plate to thousands of
                        potential buyers</p>
                    <div class="arrow">
                        <svg width="114" height="114" viewBox="0 0 114 114" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="tf-box-icon relative text-center">
                    <div class="image">
                        <img src="./assets/plates/plates/3.png" alt="">
                        <p>Step 3</p>
                    </div>
                    <h4 class="heading"><a href="#!">Sell or Buy with Ease</a></h4>
                    <p class="content">Manage your listings, communicate with interested buyers, and complete secure
